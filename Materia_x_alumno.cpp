...
void Materias_x_alumno::altaMXA(){
	
}

void Materias_x_alumno::bajaMXA(){
	
}

void Materias_x_alumno::modificarMXA(){
...
void Materias_x_alumno::listadoAlumnosPorMateria(){
...
void Materias_x_alumno::listadoMateriasPorAlumno(){
	
}

void Materias_x_alumno::bajaAlumnoDeMateria(){
